...
public class Program
{
    ...
    {
        RestTranslationClient clientREST = new RestTranslationClient(new HttpClient
        {
        ...
        while (inputString != "3")
        {
            ...
            switch (inputString)
            {
                case "1":
                    ...
                    while (inputString != ";")
                    {
                        ...
                        if (newLine == ";")
                        {
                            ...
                            List<string> listOutput = await clientREST.TranslateAsync(listInput, targetLanguage, sourceLanguage);

                            Console.WriteLine("\nTranslations:");
                            foreach (string output in listInput)
                ...
                case "2":
                    string info = await clientREST.GetServiceInfoAsync();
                    Console.Clear();
